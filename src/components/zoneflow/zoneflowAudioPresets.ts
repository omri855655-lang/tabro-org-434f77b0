...
export const MEDITATION_HISTORY_TIMELINE = [
  {
    id: "vedic-upanishadic",
    era: "1500–500 לפנה\"ס",
    title: "שורשים הודיים מוקדמים",
    detail: "במסורות הוודיות המאוחרות והאופנישדות מתחילים להופיע עיסוק פנימי בנשימה, ריכוז, ידיעה עצמית והתבוננות.",
  },
  {
    id: "early-buddhism",
    era: "המאה ה-5–4 לפנה\"ס",
    title: "בודהיזם מוקדם",
    detail: "טקסטים כמו Anapanasati ו-Satipatthana הופכים את המדיטציה לשיטה סדורה של אימון קשב, גוף ותודעה.",
  },
  {
    id: "china-chan",
    era: "המאה ה-1–10 לספירה",
    title: "מעבר לסין ו-Chan",
    detail: "עם חדירת הבודהיזם לסין מתפתחות צורות תרגול חדשות, ובהמשך מתגבשת מסורת Chan.",
  },
  {
    id: "tibet-japan",
    era: "המאה ה-7–13",
    title: "טיבט, זן ויפן",
    detail: "במקביל מתפתחות מסורות טיבטיות חזותיות-מנטריות, ו-Chan הסיני ממשיך ליפן כ-Zen.",
  },
  {
    id: "west-modern",
    era: "1893–1979",
    title: "חדירה למערב",
    detail: "ויווקאננדה מציג מסורות הודיות לקהל מערבי, ובהמשך מורים ותרגומים מביאים זן, ויפאסנה ויוגה למערב.",
  },
  {
    id: "mbsr-mainstream",
    era: "1979–היום",
    title: "מיינדפולנס מודרני",
    detail: "MBSR של Jon Kabat-Zinn עוזר להפוך מדיטציה לשפה חילונית, רפואית ומעשית שנכנסת למיינסטרים.",
  },
] as const;

export const MEDITATION_SOURCE_LINKS = [
  {
    ...
    note: "סקירה מוסדית עדכנית על יעילות, מגבלות ובטיחות.",
  },
  {
    label: "SuttaCentral — Anapanasati Sutta",
    href: "https://suttacentral.net/mn118/en/sujato",
    note: "מקור קלאסי לתרגול נשימה בבודהיזם מוקדם.",
  },
  {
    label: "SuttaCentral — Satipatthana Sutta",
    href: "https://suttacentral.net/mn10/en/horner",
    note: "מקור יסוד לקשב לגוף, תחושות ותודעה.",
  },
  {
    label: "Stanford Encyclopedia — Chan Buddhism",
    href: "https://plato.stanford.edu/archives/fall2023/entries/buddhism-chan/",
    note: "רקע טוב על מעבר המדיטציה הבודהיסטית לסין.",
  },
  {
    label: "Oxford Mindfulness",
    href: "https://courses.oxfordmindfulness.org/what-is-mindfulness",
    note: "הסבר מודרני, מוסדי וזהיר על mindfulness.",
  },
  {
    label: "Dhamma.org — Vipassana",
    href: "https://www.dhamma.org/en/about/vipassana",
    note: "הצגה מסורתית של ויפאסנה בקו Goenka.",
  },
] as const;
...
export const MEDITATION_TYPES = [
  {
    id: "breath-awareness",
    title: "מדיטציית נשימה",
    icon: "🌬️",
    origin: "בודהיזם מוקדם, במיוחד מסורת Anapanasati של קשב לנשימה.",
    history: "אחת מצורות המדיטציה המתועדות והמרכזיות ביותר בבודהיזם המוקדם. תרגול קשב לנשימה מופיע בטקסטים קלאסיים כמו Anapanasati Sutta והפך לבסיס במסורות רבות גם במזרח וגם במיינדפולנס מודרני.",
    sources: [
      { label: "SuttaCentral — Anapanasati Sutta", href: "https://suttacentral.net/mn118/en/sujato" },
      { label: "UCLA Mindful — Breathing Meditation", href: "https://www.uclahealth.org/uclamindful/guided-meditations" },
    ],
    howTo: "שב בנוח, עמוד שדרה רך אך יציב, והפנה את הקשב לכניסה וליציאה של האוויר. אין צורך לנשום 'נכון' אלא רק לשים לב. כשהמחשבה בורחת, מחזירים בעדינות לנשימה.",
    benefits: "מורידה מתח, מאטה קצב פנימי, ומשפרת יכולת לחזור לפוקוס אחרי פיזור.",
    bestFor: "לפני עבודה, בזמן סטרס, או כשיש תחושת הצפה מנטלית.",
  },
  {
    id: "body-scan",
    title: "סריקת גוף",
    icon: "🧍",
    origin: "שייך מאוד ל-MBSR המודרני, עם שורשים בתשומת לב בודהיסטית לגוף.",
    history: "סריקת גוף קיבלה צורה מודרנית וברורה במיוחד דרך MBSR של Jon Kabat-Zinn, אבל נשענת על מסורות ישנות של קשב לגוף ולתחושות. היא הפכה לאחת הפרקטיקות הכי שימושיות בין מדיטציה, רפואה ומודעות גופנית.",
    sources: [
      { label: "UMass / MBSR Background", href: "https://www.umassmed.edu/cfm/mindfulness-based-programs/mbsr-courses/" },
      { label: "UCLA Mindful — Body Scan", href: "https://www.uclahealth.org/uclamindful/guided-meditations" },
    ],
    howTo: "עוברים עם הקשב מהראש עד כפות הרגליים או להפך. בכל אזור שמים לב למתח, חום, לחץ או רפיון, בלי לנסות מיד לשנות אותם.",
    benefits: "מגבירה מודעות לגוף, מפחיתה עומס עצבי, ועוזרת לזהות מתח לפני שהוא נהיה שחיקה.",
    bestFor: "בסוף יום, לפני שינה, או אחרי ישיבה ממושכת מול מסך.",
  },
  {
    id: "open-monitoring",
    title: "מדיטציית התבוננות",
    icon: "👁️",
    origin: "מסורות בודהיסטיות של open monitoring ו-choiceless awareness.",
    history: "הגישה הזו התפתחה מתוך מסורות בודהיסטיות של מודעות פתוחה, שבהן לא נצמדים רק לאובייקט אחד אלא מתבוננים בזרם החוויה. במערב היא קיבלה שמות כמו open monitoring ו-choiceless awareness.",
    sources: [
      { label: "Frontiers — Meditation Types Review", href: "https://www.frontiersin.org/journals/psychology/articles/10.3389/fpsyg.2014.01083/full" },
      { label: "Oxford Mindfulness", href: "https://courses.oxfordmindfulness.org/what-is-mindfulness" },
    ],
    howTo: "במקום להתמקד רק בנשימה, שמים לב למחשבות, קולות ותחושות שבאות והולכות. לא נאחזים, רק מבחינים ונותנים להן לעבור.",
    benefits: "מחזקת יציבות רגשית, מרחיבה פרספקטיבה, ומקטינה היסחפות אחרי מחשבות.",
    bestFor: "כשיש רעש בראש, overthinking, או צורך באיפוס רגשי.",
  },
  {
    id: "loving-kindness",
    title: "מדיטציית חמלה",
    icon: "💛",
    origin: "Metta בבודהיזם המוקדם, ובהמשך גם במסורות חמלה מודרניות.",
    history: "מדיטציית Metta מופיעה כבר במסורות בודהיסטיות מוקדמות כתרגול של טוב לב וחום לאחרים ולעצמך. במאה ה-20 וה-21 היא נהייתה מרכזית גם בהוראה מערבית של compassion ו-self-compassion.",
    sources: [
      { label: "Insight Meditation Society", href: "https://www.dharma.org/learn/" },
      { label: "UCLA Mindful — Loving Kindness", href: "https://www.uclahealth.org/uclamindful/guided-meditations" },
    ],
    howTo: "חוזרים בלב על משפטים קצרים כמו 'הלוואי שאהיה רגוע', 'הלוואי שאהיה בטוח', ואז מרחיבים לאנשים אחרים.",
    benefits: "מרככת ביקורת עצמית, מחזקת חוסן רגשי, ועוזרת להחזיר רכות כשעובדים קשה מדי.",
    bestFor: "בזמני ביקורת עצמית, קושי רגשי, או תחושת כישלון.",
  },
  {
    id: "walking",
    title: "מדיטציית הליכה",
    icon: "🚶",
    origin: "תרגול מוכר בבודהיזם תרוואדה, זן ו-Plum Village.",
    history: "הליכה מודעת היא חלק ותיק מאוד ממסורות בודהיסטיות, במיוחד כדרך להביא מדיטציה אל התנועה עצמה. היא זכתה לפופולריות מחודשת דרך מורים כמו Thich Nhat Hanh ו-Plum Village.",
    sources: [
      { label: "Plum Village — Mindfulness Practice", href: "https://plumvillage.org/mindfulness/mindfulness-practice" },
      { label: "Mindful — Walking Meditation", href: "https://www.mindful.org/walking-meditation/" },
    ],
    howTo: "הולכים לאט ושמים לב לצעדים, למגע של כף הרגל ברצפה, ולנשימה תוך כדי תנועה.",
    benefits: "מתאימה למי שקשה לו לשבת בשקט, מחברת לגוף, ומשחררת קיפאון מנטלי.",
    bestFor: "אמצע יום, בין בלוקים של עבודה, או כשיש restlessness.",
  },
  {
    id: "mantra",
    title: "מדיטציית מנטרה",
    icon: "🕉️",
    origin: "מסורות יוגה, וודנטה וטנטרה הודיות.",
    history: "מדיטציית מנטרה יושבת עמוק במסורות הודיות עתיקות שבהן לצליל, הברה או מילה יש כוח של ריכוז, עוגן ולעיתים גם קדושה. בגרסאות מודרניות היא הופיעה גם בבתי ספר כמו TM ובתרגולי יוגה שונים.",
    sources: [
      { label: "Himalayan Institute — Science of Mantra", href: "https://himalayaninstitute.org/online/the-science-of-mantra/" },
      { label: "TM — What Is TM", href: "https://www.tm.org/en-us/what-is-tm" },
    ],
    howTo: "בוחרים מילה, הברה או משפט קצר וחוזרים עליו בשקט או בקול נמוך בקצב רגוע.",
    benefits: "מייצבת את הקשב, מפחיתה רעש פנימי, ויוצרת תחושת עוגן פשוטה וברורה.",
    bestFor: "כשקשה להישאר עם הנשימה בלבד או כשהמחשבות קופצות מהר.",
  },
  {
    id: "visualization",
    title: "מדיטציית דמיון מודרך",
    icon: "🌅",
    origin: "שורשים טיבטיים ויוגיים, ובגרסאות מודרניות גם guided imagery חילוני.",
    history: "עבודה עם דמיון פנימי הופיעה במסורות רוחניות רבות, כולל טיבטיות ויוגיות. במערב היא התפתחה גם ככלי טיפולי וחילוני להרגעה, ביטחון פנימי והחלמה.",
    sources: [
      { label: "NCCIH — Relaxation Techniques", href: "https://www.nccih.nih.gov/health/tips/things-to-know-about-relaxation-techniques-for-stress" },
      { label: "UCLA Mindful — Guided Meditations", href: "https://www.uclahealth.org/uclamindful/guided-meditations" },
    ],
    howTo: "עוצמים עיניים ומדמיינים מקום בטוח, רגוע או מרפא, עם כמה שיותר פרטים תחושתיים.",
    benefits: "מורידה מתח, עוזרת לוויסות רגשי, ומכניסה את הגוף למצב בטוח יותר.",
    bestFor: "כשצריך הרגעה מהירה או התאוששות אחרי יום עמוס.",
  },
  {
    id: "vipassana",
    title: "ויפאסנה",
    icon: "🔍",
    origin: "בודהיזם מוקדם; במסורת המודרנית מזוהה מאוד עם קווי Theravada ו-Goenka.",
    history: "ויפאסנה מזוהה עם אימון תובנה עתיק בבודהיזם, שנועד לראות את הדברים כפי שהם באמת. בעולם המודרני היא הפכה מוכרת במיוחד דרך מסורות Theravada ומרכזי Goenka.",
    sources: [
      { label: "Dhamma.org — Vipassana", href: "https://www.dhamma.org/en/about/vipassana" },
      { label: "SuttaCentral — Satipatthana Sutta", href: "https://suttacentral.net/mn10/en/horner" },
    ],
    howTo: "מתבוננים בנשימה, בתחושות ובתהליכים הפנימיים כמו שהם, בלי להגיב ובלי לשפוט.",
    benefits: "מחזקת בהירות, סבלנות, ויכולת לראות דפוסים במקום להיסחף איתם.",
    bestFor: "לתרגול עומק, לשיפור מודעות, ולחיזוק יציבות פנימית.",
  },
  {
    id: "zen-counting",
    title: "ספירת נשימות בזן",
    icon: "🍃",
    origin: "מסורת Zen/Chan, במיוחד אימוני zazen בסיסיים.",
    history: "במסורות Zen ו-Chan השתמשו לעיתים בספירת נשימות כדרך בסיסית ופשוטה לאסוף תודעה נודדת. זה נחשב תרגול כניסה קלאסי לפני העמקה לזאזן שקט יותר.",
    sources: [
      { label: "Soto Zen — Zazen", href: "https://www.sotozen.com/eng/zazen/index.html" },
      { label: "Stanford Encyclopedia — Chan Buddhism", href: "https://plato.stanford.edu/archives/fall2023/entries/buddhism-chan/" },
    ],
    howTo: "סופרים כל נשיפה מ-1 עד 10 ואז מתחילים מחדש. אם הלכת לאיבוד, חוזרים ל-1 בלי כעס.",
    benefits: "חדה, פשוטה, ומעולה לאימון מנטלי על חזרה לקשב.",
    bestFor: "לפני עבודה עמוקה או כשצריך לחדד ריכוז.",
  },
  {
    id: "yoga-nidra",
    title: "יוגה נידרה",
    icon: "🛌",
    origin: "מסורות יוגיות הודיות; בימינו גם iRest ו-NSDR מבוססים עליה.",
    history: "יוגה נידרה נשענת על מסורות יוגיות של מנוחה מודעת עמוקה. בעשורים האחרונים היא נהייתה מרכזית גם בגרסאות מודרניות כמו iRest ובהמשך גם בשיח של NSDR.",
    sources: [
      { label: "iRest — Yoga Nidra", href: "https://shop.irest.org/pages/yoga-nidra" },
      { label: "Huberman Lab — NSDR", href: "https://www.hubermanlab.com/nsdr" },
    ],
    howTo: "שוכבים בנוחות ומקשיבים להנחיה שעוברת דרך הגוף, הנשימה והמודעות, בלי להירדם בכוונה.",
    benefits: "מורידה עומס עצבי עמוק, מאפשרת התאוששות, ומרגישה כמו מנוחה משקמת.",
    bestFor: "שחיקה, עייפות עצבית, וסוף יום.",
  },
  {
    id: "gratitude",
    title: "מדיטציית הכרת תודה",
    icon: "🙏",
    origin: "פיתוח מודרני שניזון ממיינדפולנס, פסיכולוגיה חיובית ומסורות רוחניות שונות.",
    history: "מדיטציית הכרת תודה אינה שיטה עתיקה אחת עם קאנון יחיד, אלא תרגול מודרני שהתעצב מתוך שילוב של מיינדפולנס, פסיכולוגיה חיובית, יומני תודה ומסורות רוחניות שעסקו בהוקרה, תפילה ושפע פנימי.",
    sources: [
      { label: "Greater Good Science Center", href: "https://greatergood.berkeley.edu/topic/gratitude/definition" },
      { label: "NCCIH — Meditation and Mindfulness", href: "https://www.nccih.nih.gov/health/meditation-and-mindfulness-effectiveness-and-safety" },
    ],
    howTo: "מביאים לתודעה 3-5 דברים, אנשים או רגעים קטנים שיש עליהם תודה אמיתית כרגע.",
    benefits: "משנה מצב רוח, מרחיבה פרספקטיבה, ומקטינה התמקדות בחסר.",
    bestFor: "בקרים, סיום יום, או אחרי תקיעות רגשית.",
  },
  {
    id: "chakra",
    title: "מדיטציית צ'אקרות",
    icon: "🌈",
    origin: "מסורות טנטריות ויוגיות הודיות של עבודה עם מרכזי אנרגיה.",
    history: "עבודה עם צ'אקרות צמחה מתוך מסורות טנטריות ויוגיות שבהן הגוף נתפס גם כמפה אנרגטית. בגרסאות מודרניות היא נפוצה מאוד ברוחניות רכה ובתרגולי ריפוי עצמי.",
    sources: [
      { label: "Britannica — Chakra", href: "https://www.britannica.com/topic/chakra" },
      { label: "Yoga Journal", href: "https://www.yogajournal.com/" },
    ],
    howTo: "עוברים דרך מרכזי הגוף בדמיון ובנשימה, ושמים לב לאזורים שצריכים פתיחה, ריכוך או איזון.",
    benefits: "יוצרת תחושת זרימה, חיבור לגוף, והעמקה רגשית אצל מי שמתחבר לעבודה אנרגטית.",
    bestFor: "סשנים רגועים, עבודה רגשית, או רוחניות רכה.",
  },
  {
    id: "sound-bath",
    title: "מדיטציית צליל",
    icon: "🔔",
    origin: "שורשים בטקסי צליל מסורתיים; בגרסה מודרנית נפוץ ב-wellness ו-somatic work.",
    history: "שימוש בצליל להרגעה, טקס, ריפוי או טרנס הופיע בתרבויות רבות, אבל sound bath כפי שמכירים היום הוא בעיקר עיצוב מודרני של חוויה מרגיעה-תחושתית.",
    sources: [
      { label: "NCCIH — Relaxation Techniques", href: "https://www.nccih.nih.gov/health/tips/things-to-know-about-relaxation-techniques-for-stress" },
      { label: "Mindful", href: "https://www.mindful.org/" },
    ],
    howTo: "מקשיבים לצלילים מתמשכים כמו bowls, פעמונים או drones, ונותנים לקשב לנוח על הצליל.",
    benefits: "מרגיעה את המערכת מהר, עוזרת לשחרר אחיזה, ומתאימה גם למי שמתקשה במדיטציה שקטה.",
    bestFor: "איפוס עדין, כניסה להרפיה, או מעבר בין עומס למנוחה.",
  },
  {
    id: "box-breathing",
    title: "מדיטציית Box Breathing",
    icon: "⬜",
    origin: "טכניקת נשימה מודרנית לוויסות עצבי וביצועים תחת לחץ.",
    history: "Box Breathing היא טכניקת נשימה מודרנית ופשוטה שהפכה פופולרית בעיקר בשיח של ויסות, ביצועים ותפקוד תחת לחץ. היא שייכת יותר לעולם היישומי-עכשווי מאשר למסורת רוחנית עתיקה.",
    sources: [
      { label: "NCCIH — Relaxation Techniques", href: "https://www.nccih.nih.gov/health/tips/things-to-know-about-relaxation-techniques-for-stress" },
      { label: "Breathing Practices Review", href: "https://pubmed.ncbi.nlm.nih.gov/38137060/" },
    ],
    howTo: "נושמים שאיפה 4, עצירה 4, נשיפה 4, עצירה 4, במחזורים שקטים ומדודים.",
    benefits: "מאזנת את הגוף, עוזרת לייצב סטרס, ומכניסה תחושת שליטה.",
    bestFor: "לפני שיחה חשובה, לחץ, או רגעי מתח גבוה.",
  },
  {
    id: "nsdr",
    title: "NSDR / Non-Sleep Deep Rest",
    icon: "🫧",
    origin: "מטרייה מודרנית שמאגדת Yoga Nidra ותרגולי מנוחה עמוקה ללא שינה.",
    history: "NSDR הוא מונח מודרני יחסית שמטרתו לאגד צורות מנוחה עמוקה ללא שינה, במיוחד Yoga Nidra ותרגולי rest מודרכים. הוא נולד כדי לתווך תרגול עתיק בשפה עדכנית, עצבית-פונקציונלית יותר.",
    sources: [
      { label: "Huberman Lab — NSDR", href: "https://www.hubermanlab.com/nsdr" },
      { label: "iRest — Yoga Nidra", href: "https://shop.irest.org/pages/yoga-nidra" },
    ],
    howTo: "שוכבים או נשענים, עוקבים אחרי הנחיה פשוטה, ונכנסים למצב של מנוחה עמוקה בלי לדרוש שינה.",
    benefits: "תומך בהתאוששות, מוריד עומס, ומחזיר חדות אחרי עייפות.",
    bestFor: "אמצע יום, אחרי מאמץ מנטלי, או במקום 'קריסה' למסך.",
  },
  {
    id: "self-inquiry",
    title: "מדיטציית חקירה עצמית",
    icon: "❓",
    origin: "מסורות אדוויטה, וודנטה ותרגולים קונטמפלטיביים של חקירה פנימית.",
    history: "חקירה עצמית הופיעה במסורות פילוסופיות ורוחניות כמו Advaita Vedanta כדרך לחקור זהות, אני ותודעה. במערב היא קיבלה גם גרסאות פחות מטאפיזיות ויותר טיפוליות-מודעות.",
    sources: [
      { label: "Stanford Encyclopedia — Advaita Vedanta", href: "https://plato.stanford.edu/" },
      { label: "Oxford Mindfulness", href: "https://courses.oxfordmindfulness.org/what-is-mindfulness" },
    ],
    howTo: "שואלים בעדינות שאלה כמו 'מה עובר עליי עכשיו?' או 'מה אני צריך כרגע?' ומקשיבים בלי למהר לענות.",
    benefits: "מגדילה כנות פנימית, מורידה אוטומט, ומחזקת חיבור לעצמך.",
    bestFor: "קבלת החלטות, בלבול, או תקיעות רגשית.",
  },
  {
    id: "affirmation",
    title: "מדיטציית הצהרות",
    icon: "✨",
    origin: "תרגול מודרני יותר, בין קואצ'ינג, פסיכולוגיה חיובית ורוחניות יומיומית.",
    history: "הצהרות חיוביות אינן מגיעות ממסורת מדיטטיבית עתיקה אחת, אלא משילוב מודרני של פסיכולוגיה, אימון מנטלי ורוחניות יומיומית. הן נפוצות מאוד כתרגול קצר ליצירת state חדש או חיזוק כיוון פנימי.",
    sources: [
      { label: "APA", href: "https://www.apa.org/" },
      { label: "Greater Good Science Center", href: "https://greatergood.berkeley.edu/" },
    ],
    howTo: "חוזרים על משפטים מדויקים כמו 'מותר לי להתקדם לאט', 'אני חוזר לפוקוס', 'אני בטוח עכשיו'.",
    benefits: "מחזקת כיוון פנימי, מרגיעה ביקורת עצמית, ועוזרת לבנות state חדש.",
    bestFor: "בקרים, לפני אתגר, או אחרי נפילה באנרגיה.",
  },
  {
    id: "stoic-pause",
    title: "השהיה סטואית",
    icon: "🏛️",
    origin: "השראה מהפילוסופיה הסטואית, בגרסה עכשווית ומדיטטיבית.",
    history: "התרגול הזה לא מגיע ממסורת מדיטציה מזרחית אלא מהשאלה הסטואית הקלאסית: מה בשליטתי ומה לא. בגרסה מודרנית הוא הפך לכלי קצר לוויסות, פרופורציה וחזרה לפעולה.",
    sources: [
    ...
    howTo: "יושבים לדקה-שתיים עם השאלה: מה בשליטתי עכשיו ומה לא? ואז משחררים את מה שלא בידיים.",
    benefits: "מורידה לחץ מיותר, מנקה רעש, ועוזרת לחזור לפעולה מעשית.",
    bestFor: "עומס, חרדה סביב תוצאה, או דדליינים.",
  },
  {
    id: "compassion-body",
    title: "חמלה לגוף",
    icon: "🤲",
    origin: "שילוב מודרני של self-compassion, somatic awareness ומיינדפולנס.",
    history: "זהו תרגול מודרני מאוד שמחבר בין עבודת self-compassion לבין מודעות גופנית. הוא נולד מתוך גישות טיפוליות וסומטיות שרואות בגוף שער מרכזי לרוגע וביטחון.",
    sources: [
      { label: "Center for Mindful Self-Compassion", href: "https://centerformsc.org/pages/meditations-and-practices" },
      { label: "NCCIH — Meditation and Mindfulness", href: "https://www.nccih.nih.gov/health/meditation-and-mindfulness-effectiveness-and-safety" },
    ],
    howTo: "שמים יד על הלב, על הבטן או על אזור מתוח, ונושמים אליו בעדינות עם מסר של רכות.",
    benefits: "מוריד נוקשות פנימית, עוזר לגוף להרגיש בטוח יותר, ומרכך סטרס.",
    bestFor: "שחיקה, קושי רגשי, או יום תובעני במיוחד.",
  },
  {
    id: "micro-meditation",
    title: "מיקרו-מדיטציה",
    icon: "⏱️",
    origin: "פורמט מודרני שנועד לשלב מודעות ביום עמוס, בלי מסגרת תרגול ארוכה.",
    history: "מיקרו-מדיטציה היא עיבוד עכשווי מאוד של עקרונות מיינדפולנס לשגרת חיים מהירה. הרעיון הוא לקחת איכות של נוכחות ולהכניס אותה למקטעים קטנים ולא רק ל'ישיבה רשמית'.",
    sources: [
      { label: "Mindful", href: "https://www.mindful.org/" },
      { label: "Oxford Mindfulness", href: "https://courses.oxfordmindfulness.org/what-is-mindfulness" },
    ],
    howTo: "עוצרים ל-30-90 שניות, מסתכלים על הנשימה, התחושה בגוף, וקובעים כוונה אחת לרגע הבא.",
    benefits: "עושה reset קטן בלי לצאת מהיום, ושומרת על רצף מודעות גם בלו\"ז צפוף.",
    bestFor: "בין פגישות, לפני שיחה, או תוך כדי יום עמוס.",
  },
  {
    id: "tonglen",
    title: "טונגלן",
    icon: "💨",
    origin: "מסורת חמלה טיבטית של 'לקחת ולשלוח'.",
    history: "Tonglen מגיע ממסורות בודהיסטיות טיבטיות שבהן עובדים עם נשימה, חמלה ואומץ רגשי. זה תרגול שמכוון פחות רק להירגע ויותר לפתוח את הלב מול כאב.",
    sources: [
      { label: "Shambhala — Tonglen", href: "https://www.shambhala.com/videos/tonglen-the-practice-of-compassion/" },
      { label: "Opening the Heart", href: "https://www.shambhala.com/openingtheheart/" },
    ],
    howTo: "בנשימה פנימה מדמיינים קבלה אמיצה של כאב או קושי, ובנשיפה שולחים הקלה, מרחב וחמלה לעצמך או לאחרים.",
    benefits: "מחזק חמלה אמיצה, פותח את הלב, ועוזר לא לברוח מרגש אלא לפגוש אותו ברכות.",
    bestFor: "עומס רגשי, כאב של אדם קרוב, או צורך לעבוד עם רגש ולא רק להרגיע אותו.",
  },
  {
    id: "trataka",
    title: "טרטקה - מבט בנר",
    icon: "🕯️",
    origin: "תרגול יוגי קלאסי של ריכוז חזותי על נקודה אחת.",
    history: "Trataka הוא תרגול יוגי קלאסי שמופיע במסורות של ריכוז, ניקוי מנטלי ועבודה עם מבט יציב. בגרסאות מודרניות הוא מזוהה מאוד עם מבט בנר כדרך חדה ופשוטה לאסוף קשב.",
    sources: [
      { label: "Yoga Journal", href: "https://www.yogajournal.com/" },
      { label: "Himalayan Institute", href: "https://himalayaninstitute.org/" },
    ],
    howTo: "מביטים בנקודה אחת או בלהבת נר כמה דקות, ואז עוצמים עיניים ושמים לב לרושם שנותר בפנים.",
    benefits: "מחדדת ריכוז, מפחיתה קפיצות קשב, ונותנת עוגן ברור למי שמתקשה במדיטציה מופשטת.",
    bestFor: "לפני פוקוס עמוק, כשהמוח מפוזר, או למי שצריך עוגן ויזואלי.",
  },
  {
    id: "centering-prayer",
    title: "תפילה שקטה / Centering Prayer",
    icon: "🕊️",
    origin: "מסורת נוצרית קונטמפלטיבית מודרנית שמעמיקה תפילה שקטה.",
    history: "Centering Prayer עוצבה במאה ה-20 מתוך מסורת נוצרית קונטמפלטיבית, כדי לאפשר ישיבה שקטה ופנימית עם נוכחות אלוהית. היא מייצגת גשר בין תפילה לבין מדיטציה.",
    sources: [
      { label: "Contemplative Outreach", href: "https://www.contemplativeoutreach.org/about-us" },
      { label: "Centering Prayer Intro PDF", href: "https://www.contemplativeoutreach.org/wp-content/uploads/2018/05/centering_prayer_intro_bw_2018_.pdf" },
    ],
    howTo: "בוחרים מילה שקטה שמסמלת נכונות, קבלה או נוכחות, וחוזרים אליה בכל פעם שהתודעה נסחפת.",
    benefits: "יוצרת שקט פנימי, רכות, ותחושת עומק למי שמתחבר לתרגול קונטמפלטיבי.",
    bestFor: "רוחניות שקטה, חיפוש משמעות, או ישיבה פנימית עדינה.",
  },
  {
    id: "noting",
    title: "נוטינג / תיוג חוויה",
    icon: "🏷️",
    origin: "שכיח מאוד בקווי ויפאסנה ותרוואדה כאימון על זיהוי ברור של חוויה.",
    history: "תיוג חוויה הוא טכניקה מזוהה עם מסורות ויפאסנה מסוימות, במיוחד קווי תרגול שמדגישים בהירות ותשומת לב דקה למה שמתרחש. הוא נעשה פופולרי גם במערב כדרך יעילה לא להיסחף אחרי מחשבה.",
    sources: [
      { label: "Dhamma.org — Vipassana", href: "https://www.dhamma.org/en/about/vipassana" },
      { label: "Frontiers — Meditation Types Review", href: "https://www.frontiersin.org/journals/psychology/articles/10.3389/fpsyg.2014.01083/full" },
    ],
    howTo: "כשמופיעה מחשבה, תחושה או רגש, נותנים לה שם קצר כמו 'מחשבה', 'דאגה', 'צליל', ואז חוזרים לנוכחות.",
    benefits: "מגדיל מרחק בריא מהחוויה, מפחית היסחפות, ומחזק מטא-מודעות.",
    bestFor: "overthinking, רעש פנימי, או אימון על זיהוי מוקדם של דפוסים.",
  },
  {
    id: "progressive-relaxation",
    title: "הרפיה פרוגרסיבית",
    icon: "🫠",
    origin: "טכניקת גוף מודרנית מרפואת גוף-נפש והרפיה יישומית.",
    history: "הרפיה פרוגרסיבית צמחה יותר מתוך רפואת גוף-נפש ופסיכולוגיה יישומית מאשר מתוך מסורת רוחנית. היא נועדה להראות לגוף את ההבדל בין כיווץ לשחרור ולבנות רוגע דרך התחושה.",
    sources: [
      { label: "NCCIH — Relaxation Techniques", href: "https://www.nccih.nih.gov/health/tips/things-to-know-about-relaxation-techniques-for-stress" },
      { label: "APA", href: "https://www.apa.org/" },
    ],
    howTo: "מכווצים ומשחררים קבוצות שרירים או פשוט עוברים איבר-איבר ומזמינים ריכוך ושחרור.",
    benefits: "מורידה מתח גופני, מכינה לשינה, ועוזרת במיוחד כשקשה 'להירגע דרך הראש'.",
    bestFor: "לפני שינה, אחרי יום תובעני, או כשיש הרבה מתח מצטבר בגוף.",
  },
] as const;
...
export const MEDITATION_SESSIONS = [
  {
    id: "reset-2",
    title: "ריסט של 2 דקות",
    duration: "2 דקות",
    goal: "לעצור את המרוץ בראש ולהתייצב מהר.",
    steps: [
      "שב או עמוד במקום יציב.",
      "קח 3 נשימות איטיות בלי לכפות עומק.",
      "ספר 10 נשימות: שאיפה 1, נשיפה 1, עד 10.",
      "אם הלב רץ, רק שים לב וחזור לספירה.",
    ],
    presetId: "wellness-meditation-reset",
  },
  {
    id: "breath-5",
    title: "נשימה מודרכת ל-5 דקות",
    duration: "5 דקות",
    goal: "להוריד עומס ולווסת את הגוף לפני עבודה או שינה.",
    steps: [
      "שאיפה ל-4, נשיפה ל-6.",
      "שמור כתפיים רכות ולסת משוחררת.",
      "אם קשה לספור, חזור למשפט קצר: 'אני כאן'.",
      "בסיום, שב עוד 20 שניות לפני קימה.",
    ],
    presetId: "wellness-breathwork",
  },
  {
    id: "focus-8",
    title: "חזרה לפוקוס ב-8 דקות",
    duration: "8 דקות",
    goal: "לנקות פיזור ולהיכנס לעבודה עם פחות רעש מנטלי.",
    steps: [
      "2 דקות תשומת לב לנשימה.",
      "3 דקות סריקת גוף קצרה מהפנים לכתפיים ולחזה.",
      "2 דקות זיהוי מחשבות בלי להיכנס אליהן.",
      "דקה אחרונה: ניסוח משימה אחת בלבד להמשך.",
    ],
    presetId: "wellness-reset-window",
  },
  {
    id: "deep-12",
    title: "מדיטציה עמוקה ל-12 דקות",
    duration: "12 דקות",
    goal: "להוריד קצב פנימי וליצור רוגע יציב יותר.",
    steps: [
      "התחל ב-2 דקות נשימה טבעית.",
      "המשך ל-5 דקות התבוננות בתחושות הגוף.",
      "עוד 3 דקות פשוט שים לב למחשבות בלי תגובה.",
      "2 דקות אחרונות: שאל 'מה אני צריך עכשיו?' והקשב.",
    ],
    presetId: "theta-calm",
  },
  {
    id: "sleep-prep-10",
    title: "הכנה לשינה ב-10 דקות",
    duration: "10 דקות",
    goal: "להוריד קצב, לרכך את הגוף, ולהתקרב לשינה רגועה.",
    steps: [
      "2 דקות נשימה ארוכה ועדינה.",
      "4 דקות סריקת גוף איטית מהראש לרגליים.",
      "2 דקות הכרת תודה שקטה.",
      "2 דקות שחרור מחשבות בלי לנתח.",
    ],
    presetId: "theta-light",
  },
  {
    id: "walking-6",
    title: "הליכה מודעת ל-6 דקות",
    duration: "6 דקות",
    goal: "להוציא קיפאון מהגוף בלי לוותר על קשב ומודעות.",
    steps: [
      "התחל הליכה איטית.",
      "שים לב למגע של הרגליים ברצפה.",
      "סנכרן נשימה וצעדים בקצב טבעי.",
      "בסיום עצור לחצי דקה והרגש את הגוף.",
    ],
    presetId: "ocean-breath",
  },
  {
    id: "stress-4",
    title: "שחרור סטרס ב-4 דקות",
    duration: "4 דקות",
    goal: "להוריד מתח מיידי ולחזור לתפקוד.",
    steps: [
      "דקה אחת Box Breathing.",
      "דקה אחת שחרור כתפיים ולסת.",
      "דקה אחת חזרה לנשימה רגילה.",
      "דקה אחת ניסוח פעולה אחת להמשך.",
    ],
    presetId: "wellness-breathwork",
  },
  {
    id: "metta-7",
    title: "חמלה ונדיבות ל-7 דקות",
    duration: "7 דקות",
    goal: "לרכך ביקורת עצמית ולהכניס יותר חום פנימי.",
    steps: [
      "הנח יד על הלב או הבטן.",
      "חזור על משפטים כמו: 'הלוואי שאהיה רגוע, בטוח, וקל איתי'.",
      "אחרי כמה דקות הרחב את האיחול לאדם קרוב.",
      "סיים בדקה שקטה בלי לנסות להרגיש משהו מסוים.",
    ],
    presetId: "wellness-meditation-reset",
  },
  {
    id: "nsdr-15",
    title: "NSDR להתאוששות ב-15 דקות",
    duration: "15 דקות",
    goal: "להוריד עומס עצבי ולהחזיר חדות בלי להירדם בכוח.",
    steps: [
      "שכב או הישען במצב נוח מאוד.",
      "אפשר לעיניים להיות עצומות ונשימה טבעית.",
      "העבר את הקשב בין הגוף, הנשימה והקולות מסביב.",
      "אם המחשבה נודדת, חזור פשוט לתחושת המשקל של הגוף.",
    ],
    presetId: "wellness-reset-window",
  },
  {
    id: "candle-5",
    title: "ריכוז עם נר ב-5 דקות",
    duration: "5 דקות",
    goal: "לאסוף קשב מפוזר לעוגן אחד פשוט.",
    steps: [
      "הצב נר או נקודה יציבה מולך.",
      "התבונן בשקט בלי לנתח.",
      "כשעולות מחשבות, חזור למבט ולנשימה.",
      "בסיום עצום עיניים לחצי דקה ושים לב לאפטר-אימג'.",
    ],
    presetId: "focus-alpha-flow",
  },
] as const;

export const MEDITATION_VIDEO_TOPICS = [
  {
    id: "cYFNaU3I5hE",
    title: "נשימה מודרכת — 10 דקות",
    desc: "וידאו לנשימה מודעת, האטת קצב והרגעה מהירה.",
    bestFor: "כשצריך להתחיל בקלות עם הנחיה חיצונית.",
  },
  {
    id: "ZToicYcHIOU",
    title: "Body Scan — סריקת גוף",
    desc: "סרטון שמלווה אותך בסריקת גוף איטית והרפיה.",
    bestFor: "מתח בגוף, לפני שינה, או אחרי מסך.",
  },
  {
    id: "sz7cpV7ERsM",
    title: "Loving Kindness",
    desc: "תרגול חמלה לעצמך ולאחרים.",
    bestFor: "ביקורת עצמית, עומס רגשי, או צורך ברכות.",
  },
  {
    id: "7H0FKzeuVVs",
    title: "Yoga Nidra",
    desc: "מדיטציית מנוחה עמוקה מונחית.",
    bestFor: "שחיקה, עייפות עצבית, וסוף יום.",
  },
  {
    id: "TnPZm2CgEWQ",
    title: "Vipassana Meditation",
    desc: "הנחיה להתבוננות שקטה בנשימה ובתחושות.",
    bestFor: "תרגול עומק ובהירות.",
  },
  {
    id: "aC9It5c2B0Q",
    title: "Walking Meditation",
    desc: "וידאו להליכה מודעת בקצב רגוע.",
    bestFor: "כשקשה לשבת במקום.",
  },
  {
    id: "inpok4MKVLM",
    title: "Reset קצר לחרדה",
    desc: "הכוונה קצרה להורדת עומס ולחץ.",
    bestFor: "עומס מהיר, חרדה, או הצפה.",
  },
  {
    id: "ssss7V1_eyA",
    title: "10 Minute Meditation",
    desc: "מדיטציה כללית שקטה ונגישה למתחילים.",
    bestFor: "כניסה פשוטה לתרגול יומי.",
  },
  {
    id: "U9YKY7fdwyg",
    title: "Sleep Meditation",
    desc: "הכוונה שקטה לקראת שינה ורפיון.",
    bestFor: "ערב, לילה, או אחרי יום עמוס.",
  },
] as const;
...
export const MOTIVATION_TIPS = [
  ...
  },
  {
    ...
    icon: "💼",
    content: "עקרונות ממחקרי מוטיבציה מדגישים אוטונומיה, תחושת מסוגלות ומשמעות. גם אם אתה לא אוהב את העבודה, מצא פיסת משמעות אחת קטנה. שאל: 'מה הדבר הכי קטן שאני יכול לעשות עכשיו שייתן לי תחושת שליטה?' אין כאן הבטחה לאחוז שיפור קבוע.",
  },
  {
    id: "hate-job-tips",
    title: "איך לעבוד כשאתה שונא",
    icon: "😤",
    content: "1) הפרד בין הרגש למעשה — 'אני לא אוהב את זה' ≠ 'אני לא יכול לעשות את זה'. 2) מצא מקור שליטה אחד — עמית טוב, משימה מעניינת, או הפסקה. 3) הפוך את זה לניסוי קצר — כמה אפשר לעשות ב-10 דקות? 4) זכור למה — המשכורת, הניסיון, הצעד הבא. שינוי השפה מ'חייב' ל'בוחר' הוא כלי רפלקטיבי, לא הבטחה לאחוז שיפור.",
  },
  {
    id: "difficult-people",
    title: "עבודה עם אנשים קשים",
    icon: "🤝",
    content: "אין מספר אחד שמתאים לכל מקום עבודה. טיפים: 1) אל תיקח באופן אישי — ההתנהגות שלהם לא מגדירה אותך. 2) גבולות ברורים — 'אני שמח לעזור כשנדבר בטון מכבד.' 3) תעד החלטות. 4) חפש בעל ברית — מנטור או עמית תומך.",
  },
  {
    id: "boring-tasks",
    title: "איך להתמודד עם משימות משעממות",
    icon: "🥱",
    content: "היקף המשימות השגרתיות משתנה בין תפקידים. טכניקות: 1) Batch Processing — קבץ משימות דומות. 2) הוסף אתגר קטן — 'אעבוד על זה 15 דקות'. 3) תגמול מיידי — אחרי כל משימה, דקה של משהו שאתה אוהב. 4) Body Doubling — עבוד ליד מישהו, גם וירטואלית.",
  },
  {
    id: "five-second-start",
    title: "חוק 5 השניות",
    icon: "🚀",
    content: "כלל פרקטי של Mel Robbins: כשאתה מזהה פעולה נכונה, ספור 5-4-3-2-1 ובצע את הצעד הראשון. חשוב: זהו כלי התנהגותי פופולרי, לא ממצא מדעי בפני עצמו. אם הוא יוצר לחץ, החלף אותו בצעד קטן ועדין יותר.",
  },
  {
    id: "if-then-plan",
    title: "תוכנית אם-אז",
    icon: "🧩",
    content: "עיקרון שנתמך במחקר על implementation intentions: 'אם יקרה X, אז אעשה Y'. לדוגמה: אם אכין קפה, אז אפתח את המסמך ואכתוב כותרת אחת. התוכנית עובדת טוב יותר כשהפעולה מוגדרת וזעירה.",
  },
  {
    id: "graded-start",
    title: "סולם התחלה",
    icon: "🪜",
    content: "מבוסס על עקרונות של graded task assignment ו-Behavioral Activation: אם משימה גדולה מדי, בחר גרסה של 2 דקות, בדוק מה עזר, ורק אז הגדל. המטרה היא התחלה אמיתית, לא הבטחה למצב רוח טוב.",
  },
];
