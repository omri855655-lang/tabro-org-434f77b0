...
const JOURNEYS: MindJourney[] = [
  ...
  {
    id: "consistency-friction",
    title: "לבנות עקביות בלי להישחק",
    subtitle: "להבין למה מתחילים חזק ונעצרים",
    summary: "עקביות אינה מבחן אופי. נבדוק חיכוך, ציפיות וסביבה ונבנה קצב שאפשר לחזור אליו גם אחרי יום פחות טוב.",
    duration: 7,
    minutes: 10,
    questions: 4,
    accent: "from-[#0d6473] via-[#118a91] to-[#52c7b8]",
    accentSoft: "bg-[#e6f8f5] text-[#0b716f]",
    icon: "🌱",
    coachPrompt: "אני מתחיל דברים בהתלהבות אבל לא מצליח להתמיד.",
    days: [
      { day: 1, title: "לזהות את רגע הנשירה", body: "חזור לפעם האחרונה שעצרת. בדוק מה השתנה בזמן, באנרגיה או בסביבה.", prompt: "באיזה רגע בדיוק הפסקת לחזור להרגל?" },
      { day: 2, title: "להקטין את גרסת המינימום", body: "הגדר גרסה שאפשר לבצע גם ביום עמוס: עמוד אחד, חמש דקות או פעולה אחת.", prompt: "מהי הגרסה הקטנה ביותר שעדיין נחשבת המשכיות?" },
      { day: 3, title: "לקשור לעוגן קיים", body: "חבר את הפעולה להרגל שכבר קורה, כמו קפה, הגעה הביתה או פתיחת המחשב.", prompt: "אחרי איזו פעולה קיימת הכי טבעי להתחיל?" },
      { day: 4, title: "להוריד החלטות", body: "הכן מראש שעה, מקום וחומרי עבודה כדי לא לנהל משא ומתן עם עצמך.", prompt: "איזו החלטה חוזרת אפשר לבטל מראש?" },
      { day: 5, title: "למדוד חזרה, לא רצף", body: "יום שהוחמץ אינו כישלון. המדד החשוב הוא כמה מהר חזרת.", prompt: "מה יעזור לך לחזור כבר ביום הבא?" },
      { day: 6, title: "לשמור מקום להנאה", body: "בחר מרכיב אחד שמספק סקרנות, מוזיקה, חברה או שינוי סביבה.", prompt: "מה יהפוך את ההרגל לפחות כבד?" },
      { day: 7, title: "לכתוב חוזה ריאלי", body: "קבע תדירות מינימום, סימן הצלחה ותוכנית חזרה אחרי הפסקה.", prompt: "מהי ההתחייבות שאתה באמת מסוגל לקיים בחודש הקרוב?" },
    ],
  },
  {
    id: "perfectionism-control",
    title: "לשחרר שלמות ושליטה",
    subtitle: "להתקדם גם כשלא הכול ודאי",
    summary: "כששלמות הופכת להגנה מפני ביקורת או חוסר ודאות, נלמד להגדיר 'מספיק טוב' ולהוציא דברים לעולם בהדרגה.",
    duration: 7,
    minutes: 11,
    questions: 4,
    accent: "from-[#7c2d12] via-[#ea580c] to-[#fbbf24]",
    accentSoft: "bg-[#fff3df] text-[#b54708]",
    icon: "🧩",
    coachPrompt: "אני מנסה לשלוט בהכול ולכן מתקשה לסיים או לשחרר.",
    days: [
      { day: 1, title: "להגדיר מספיק טוב", body: "כתוב מראש שלושה תנאים שמספיקים כדי שהמשימה תהיה ראויה למסירה.", prompt: "מה חייב להיות טוב, ומה רק נחמד שיהיה?" },
      { day: 2, title: "למצוא את האיום", body: "בדוק מה נדמה שיקרה אם תהיה טעות קטנה או תגובה לא מושלמת.", prompt: "ממה השלמות מנסה להגן עליך?" },
      { day: 3, title: "טיוטה שאסור ללטש", body: "צור במשך 15 דקות גרסה ראשונה שמטרתה רק להתקיים.", prompt: "מה אפשר לייצר היום בלי לערוך תוך כדי?" },
      { day: 4, title: "מעגל שליטה", body: "חלק דף למה בשליטתך, למה בהשפעתך ולמה מחוץ לשניהם.", prompt: "איזה דבר שאינו בשליטתך אתה עדיין מנסה לנהל?" },
      { day: 5, title: "חשיפה קטנה", body: "שתף גרסה חלקית עם אדם בטוח ובקש משוב על דבר אחד בלבד.", prompt: "מי יכול לראות טיוטה בלי להפוך אותה למבחן?" },
      { day: 6, title: "זמן סיום קשיח", body: "קבע שעה שבה עוצרים, גם אם תמיד אפשר לשפר עוד.", prompt: "מתי שיפור נוסף כבר לא מצדיק את המחיר?" },
      { day: 7, title: "ללמוד מהמציאות", body: "שלח, פרסם או סגור משהו קטן. מידע אמיתי עדיף על ניחושים מושלמים.", prompt: "מה תוכל לשחרר השבוע כדי ללמוד מה קורה באמת?" },
    ],
  },
  {
    id: "rest-and-energy",
    title: "להבין את צורכי המנוחה שלי",
    subtitle: "מנוחה שמחזירה אנרגיה ולא רק הפסקה",
    summary: "נבדיל בין עייפות גופנית, עומס מחשבתי, שחיקה וחוסר גירוי. עייפות מתמשכת או חריגה ראויה גם לבירור רפואי מקצועי.",
    duration: 7,
    minutes: 9,
    questions: 3,
    accent: "from-[#183153] via-[#446c9c] to-[#a7c7e7]",
    accentSoft: "bg-[#edf5fc] text-[#315f8d]",
    icon: "🛟",
    coachPrompt: "אני עייף הרבה ולא יודע איזו מנוחה באמת תעזור לי.",
    days: [
      { day: 1, title: "מפת אנרגיה", body: "סמן שלוש נקודות ביום: מתי האנרגיה עולה, יורדת ומתאפסת.", prompt: "באיזו שעה הגוף שלך מבקש הכי הרבה תמיכה?" },
      { day: 2, title: "איזה סוג עייפות", body: "הבחן בין צורך בשינה, שקט, תנועה, קשר אנושי או הפסקה מהחלטות.", prompt: "איזה סוג מנוחה חסר לך היום?" },
      { day: 3, title: "הפסקה משקמת", body: "נסה 10 דקות ללא גלילה: הליכה, מתיחה, עיניים עצומות או אוויר בחוץ.", prompt: "איך האנרגיה השתנתה אחרי הפסקה בלי מסך?" },
      { day: 4, title: "לצמצם דליפות", body: "זהה רעש, התראה או משימה פתוחה שגוזלים כוח בלי לשים לב.", prompt: "מה שואב ממך אנרגיה שוב ושוב?" },
      { day: 5, title: "משחק וסקרנות", body: "פנה זמן לפעילות שאין לה יעד ביצועי: יצירה, משחק, מוזיקה או תנועה.", prompt: "מה עשית פעם רק כי היה לך כיף?" },
      { day: 6, title: "גבול לפני התרוקנות", body: "קבע סימן מוקדם להפסקה, לפני שהגוף כבר מכריח אותך לעצור.", prompt: "איזה סימן אומר שהגיע הזמן להאט?" },
      { day: 7, title: "תוכנית אנרגיה", body: "בחר שתי הפסקות משקמות ושעת סיום אחת לשבוע הבא. אם העייפות חריגה או מתמשכת, פנה לבדיקה מקצועית.", prompt: "מה תכניס ליומן כדי לא לחכות לקריסה?" },
    ],
  },
  {
    id: "authentic-work",
    title: "לעבוד מתוך קול אמיתי",
    subtitle: "להבדיל בין פחד, ציפיות ורצון אישי",
    summary: "מסלול לאנשים שמרגישים שהם פועלים לפי מה שצריך, אבל מתקשים לשמוע מה באמת חשוב להם בעבודה וביצירה.",
    duration: 7,
    minutes: 12,
    questions: 4,
    accent: "from-[#4c1d95] via-[#7c3aed] to-[#ec4899]",
    accentSoft: "bg-[#f7edff] text-[#7435b5]",
    icon: "🧭",
    coachPrompt: "אני לא בטוח אם הדרך שלי בעבודה באמת מתאימה לי.",
    days: [
      { day: 1, title: "רגעים של חיות", body: "כתוב שלושה רגעים בעבודה שבהם הרגשת סקרנות, משמעות או זרימה.", prompt: "מה עשית ברגע האחרון שבו הרגשת חי בעבודה?" },
      { day: 2, title: "קולות מבחוץ", body: "רשום אילו ציפיות של משפחה, מנהלים או חברה מנהלות את הבחירות שלך.", prompt: "איזה 'צריך' אינו באמת שלך?" },
      { day: 3, title: "ערכי עבודה", body: "בחר שלושה ערכים חשובים, למשל חופש, יציבות, למידה, השפעה או שייכות.", prompt: "על איזה ערך אינך רוצה להתפשר?" },
      { day: 4, title: "פחד מול אי התאמה", body: "פחד יכול להופיע גם בדרך נכונה. בדוק אם יש סקרנות מתחתיו או רק כיווץ מתמשך.", prompt: "מה מפחיד אותך, ומה פשוט מרגיש לא נכון?" },
      { day: 5, title: "ניסוי קטן", body: "במקום החלטה גדולה, תכנן ניסוי של שעה: שיחה, פרויקט צד או למידה.", prompt: "איזה ניסוי יספק לך מידע בלי לסכן הכול?" },
      { day: 6, title: "שיחה כנה", body: "נסח צורך אחד שאפשר לבקש בסביבה הקיימת: אחריות, גבול, משוב או גמישות.", prompt: "איזה שינוי קטן יכול להפוך את העבודה ליותר שלך?" },
      { day: 7, title: "כיוון ל-30 יום", body: "בחר פעולה אחת להעמקה ופעולה אחת להפסקה בחודש הקרוב.", prompt: "מה אתה מתחיל ומה אתה מפסיק כדי להתקרב לעצמך?" },
    ],
  },
];
